    ...
    public class MJava
    {
        ...
        public void DownloadJavaAsync()
        {
            ...
            using (var wc = new WebClient())
            {
                ...
                var url = job[Environment.Is64BitOperatingSystem ? "64" : "32"]["jdk"]["url"].ToString();
        ...
        public void DownloadJava()
        {
            ...
            using (var wc = new WebClient())
            {
                ...
                var job = JObject.Parse(json)["windows"];
                javaUrl = job[Environment.Is64BitOperatingSystem ? "64" : "32"]["jdk"]["url"].ToString();
